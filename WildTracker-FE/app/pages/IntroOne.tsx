...
import img from '../../assets/images/intro1.png'
import progress from '../../assets/images/progressbar1.png'
    ...
    <SafeAreaView className='flex items-center justify-center h-full bg-white '>
      ...
      <View className='p-8 w-full  '>
        ...
        <View className='pl-10'>
            <Text className='text-2xl font-bold text-emerald-800 my-2'>Report leopard 
            </Text>
